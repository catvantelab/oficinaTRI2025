...
São 10 itens. Confirmar que os itens são dicotômicos
...
ggplot() +
  ...
  labs(title='Curva de densidade e de informação', x= "escore", y = "densidade") +
  geom_line(aes(x = seq(-3, 3, .01), y = info / 45), linetype = 2) +
  scale_y_continuous(limits = c(0, limite_densidade),
...
Análise de DIF após nova calibração (lembrando que o Item_2 e o Item_8 estão livres)
